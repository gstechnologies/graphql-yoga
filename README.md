...
| `host`          | String                                                           | `null`          | Determines the hostname your server will be listening on (note that you can also specify the host by setting the `HOST` environment variable). Default is `localhost`                                                                                                                                                        |
